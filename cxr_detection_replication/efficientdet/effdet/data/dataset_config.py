...
class Coco2017Cfg(CocoCfg):
    ...
    splits: Dict[str, dict] = field(default_factory=lambda: dict(
        train=dict(ann_filename='annotations_coco/instances_train2017.json', img_dir='train2017', has_labels=True),
        val=dict(ann_filename='annotations_coco/instances_val2017.json', img_dir='val2017', has_labels=True),
        test=dict(ann_filename='annotations_coco/image_info_test2017.json', img_dir='test2017', has_labels=False),
        testdev=dict(ann_filename='annotations_coco/image_info_test-dev2017.json', img_dir='test2017', has_labels=False),
    ))
...
class Coco2014Cfg(CocoCfg):
    variant: str = '2014'
    splits: Dict[str, dict] = field(default_factory=lambda: dict(
        train=dict(ann_filename='annotations_coco/instances_train2014.json', img_dir='train2014', has_labels=True),
        val=dict(ann_filename='annotations_coco/instances_val2014.json', img_dir='val2014', has_labels=True),
